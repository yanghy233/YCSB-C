...
# benchmark
#./ycsbc -db rocksdb -threads 32 -P workloads/workload10GB.spec 1>res/w1.out 2>res/w2.txt
./ycsbc -db cruisedb -threads 32 -P workloads/workload10GB.spec 1>res/w1.out 2>res/w1.txt
