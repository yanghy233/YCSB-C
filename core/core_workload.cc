...
/**
 * Value decided by field_count_, when field_count_ = 2, this might be:
 * values: { <"field0", v0>,    <"field1", v1> }
 * the length of v0 and v1 is decided by field_len_generator_,
 * which will be initialized in GetFieldLenGenerator() and set fieldLength in properties file
 * @param values
 */
